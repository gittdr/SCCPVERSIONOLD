        ...
        public void iniciaDatos()
        {
            ...
            //DESDE AQUI EMPIZA EL TXT DE PRODUCCION
                ...
                generarTXTTralix();
                    ...
                    ScriptManager.RegisterStartupScript(this, GetType(), "swal", "swal('" + msg + "', '', 'error');setTimeout(function(){window.location.href ='Listado.aspx'}, 3000)", true);
                    }
